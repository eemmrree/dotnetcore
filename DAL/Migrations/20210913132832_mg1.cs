        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AboutDetail1 = table.Column<int>(type: "int", nullable: false),
                    AboutDetail2 = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactStatus = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WriterID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WriterName = table.Column<int>(type: "int", nullable: false),
                    WriterAbout = table.Column<int>(type: "int", nullable: false),
                    WriterImage = table.Column<int>(type: "int", nullable: false),
                    WriterMail = table.Column<int>(type: "int", nullable: false),
                    WriterPassword = table.Column<int>(type: "int", nullable: false),
                    WriterStatus = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
